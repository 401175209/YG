...
namespace YG.TagHelper
{
    [HtmlTargetElement("yg:treecontainer", Attributes = REQUIRED_ATTR_NAME, TagStructure = TagStructure.NormalOrSelfClosing)]
...
";
                ...
                var script = $@"
<div id=""div{Id}outer"" class=""layui-col-md2 donotuse_pdiv"" style=""padding-right:10px;"">
 <div class=""layui-card"" style=""height:100%;border-color: #e6e6e6;border-width: 1px;
border-style: solid;"">
          <div class=""layui-card-header"" style=""background-color: #f2f2f2;border-bottom: 1px solid #e6e6e6;"" >机构</div>
        <div class=""layui-card-body"">
          <div id=""div{Id}"" class=""donotuse_fill"" style=""overflow:auto;height:500px;"">
            </div>
        </div>
      </div>
