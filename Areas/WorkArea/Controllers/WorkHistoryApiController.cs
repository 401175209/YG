...
using YG.WorkArea.ViewModels.WorkHistoryVMs;
using YG.Models;
...
namespace YG.Controllers
{
	...
	public partial class WorkHistoryApiController : BaseApiController
    {
        ...
        [HttpGet("{id}")]
        public WorkHistoryApiVM Get(string id)
        {
            var vm = CreateVM<WorkHistoryApiVM>(id);
            return vm;
        }

        [ActionDescription("Create")]
        [HttpPost("Add")]
        public IActionResult Add(WorkHistoryApiVM vm)
        {
        ...
        [HttpPut("Edit")]
        public IActionResult Edit(WorkHistoryApiVM vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorJson());
        ...
        {
            var vm = CreateVM<WorkHistoryApiBatchVM>();
        ...
        {
            var vm = CreateVM<WorkHistoryApiImportVM>();
        ...
        [HttpPost("Import")]
        public ActionResult Import(WorkHistoryApiImportVM vm)
        {
        ...
        {
            return Ok(DC.Set<Admin>().GetSelectListItems(LoginUserInfo?.DataPrivileges, null, x => x.CodeAndName));
        }
